...
function saveToLocalStorage(e) {
    ...
    axios.post(`https://crudcrud.com/api/29f99baab31e4823b09eba68b3ed360a/appointmentData`,obj1)
    .then((res)=>{
...
window.addEventListener('DOMContentLoaded',()=>{
    let datas;
    axios.get(`https://crudcrud.com/api/29f99baab31e4823b09eba68b3ed360a/appointmentData`)
    .then(res=>{
